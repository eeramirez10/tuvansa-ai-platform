...
export class OpenAiSupplierQuoteExtractorAdapter implements SupplierQuoteExtractorPort {
  ...
  private normalize(value: unknown, fileName: string): SupplierQuoteResult {
    ...
    return {
      ...
      supplier: {
        ...
        country: this.text(supplierRaw.country),
        ...
        schema: {
          ...
          properties: {
            supplier: {
              type: "object",
              additionalProperties: false,
              required: ["name", "taxId", "state", "country", "contactName", "email", "phone", "contacts", "confidence", "evidence"],
              properties: {
  ...
  private systemPrompt(): string {
    return [
      ...
      "Extrae supplier.country cuando la direccion, dominio o encabezado lo indiquen claramente; no lo infieras solo por el idioma.",
